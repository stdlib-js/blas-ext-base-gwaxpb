...
```javascript
import gwaxpb from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwaxpb@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwaxpb@esm/index.mjs';
```
