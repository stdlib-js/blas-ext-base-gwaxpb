...
interface Routine {
	...
	* // w => [ -7.0, 8.0, 18.0, -22.0, 23.0, 3.0, -2.0, -12.0 ]
	*/
	<T extends InputArray = InputArray>( N: number, alpha: number, beta: number, x: InputArray, strideX: number, w: T, strideW: number ): T;
	...
	* // w => [ -7.0, 8.0, 18.0, -22.0, 23.0, 3.0, -2.0, -12.0 ]
	*/
	ndarray<T extends InputArray = InputArray>( N: number, alpha: number, beta: number, x: InputArray, strideX: number, offsetX: number, w: T, strideW: number, offsetW: number ): T;
}
